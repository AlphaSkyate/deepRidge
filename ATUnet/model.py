...
class AttentionUNet2D(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        # Attention Gate
        self.att4 = AttentionGates2D(F_g=512, F_l=512, F_int=256)
        self.att3 = AttentionGates2D(F_g=256, F_l=256, F_int=128)
        self.att2 = AttentionGates2D(F_g=128, F_l=128, F_int=64)
        self.att1 = AttentionGates2D(F_g=64, F_l=64, F_int=32)
...
if __name__ == '__main__':
    data_ = torch.rand(1, 1, 416, 416)
    model = AttentionUNet2D(in_channels=1, out_channels=1)
    # print(model)
